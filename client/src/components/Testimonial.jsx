    ...
    const dummyTestimonialData = [
        {
            ...
            content: 'Quick AI helped me instantly review dozens of resumes with incredible accuracy. It’s a game-changer for recruitment!',
            rating: 4,
        },
        {
            ...
            content: 'With Quick AI, I can remove image backgrounds in seconds. It’s fast, clean, and super reliable.',
            rating: 5,
        },
        {
            ...
            content: 'Writing articles used to take hours—now Quick AI helps me generate SEO-friendly content in minutes!',
            rating: 4,
        },
    ]
                ...
                {dummyTestimonialData.map((testimonial, index) => (
                    <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition duration-300 cursor-pointer'>
                        <div className="flex items-center gap-1">
                            {Array(5).fill(0).map((_, img)=>(<img key={index} src={index<testimonial.rating ? assets.star_icon :
